...
- Iterate through backpackObjectArray
- Create a new article with the id matching the id field in the backpack object
- Use the backpackAge funtion and add it in place of the purchase date (dateAcquired)
- Populate and return content with a HTML structure matching the example
